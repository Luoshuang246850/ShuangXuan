		...
		<div class="user-search-pat">
			<el-form :inline="true" size="mini">
				<el-form-item label="岗位名称">
					<el-input v-model="search.number" placeholder="请输入岗位名称"></el-input>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" @click="doSearch">搜 索</el-button>
					<el-button type="danger" @click="cleanSearch">清 空</el-button>
					<el-button type="primary" @click="showAddUser">添加岗位</el-button>
				</el-form-item>
			</el-form>
		</div>
		<!--显示内容-->
		<div class="list-box margin-bottom-20">
			<el-table ref="multipleTable" v-loading="loading" :data="userList" tooltip-effect="dark" @selection-change="handleSelectionChange" style="width: 100%">
				<el-table-column type="selection" width="55">
				</el-table-column>
				<el-table-column fixed prop="id" label="ID" width="100">
				</el-table-column>
				<el-table-column prop="number" label="岗位名称" width="150">
				</el-table-column>
				<el-table-column prop="name" label="公司名称" width="150">
				</el-table-column>
				<el-table-column prop="college" label="职位描述" width="150">
				</el-table-column>
				<el-table-column prop="department" label="岗位薪酬" width="150">
				</el-table-column>
				<el-table-column prop="department" label="已报名人数" width="150">
				</el-table-column>
				<el-table-column prop="department" label="名额" width="150">
				</el-table-column>
				<el-table-column prop="passwd" label="实习时长（月）" width="150">
				</el-table-column>
				<el-table-column prop="passwd" label="开始时间" width="150">
				</el-table-column>
				<el-table-column prop="passwd" label="结束时间" width="150">
				</el-table-column>
		...
		<div class="user-list-dialog-box">
			...
			<el-dialog :close-on-press-escape="false" :close-on-click-modal="false" :title="editTitle" :visible.sync="editorDialogShow" width="500px">
				<el-form>
					...
					<el-form-item label="岗位薪酬" :label-width="formLabelWidth">
						<el-input v-model="form.college"></el-input>
					</el-form-item>
					<el-form-item label="实习时长（月）" :label-width="formLabelWidth">
			...
			<el-dialog :close-on-press-escape="false" :close-on-click-modal="false" title="删除提示" :visible.sync="deleteDialogShow" width="400px">
...
<script>
	...
	export default {
		...
		methods: {
			...
			doSearch() {
				api.doUserSearch(this.search.number, this.search.name, this.search.college, this.search.department).then(result => {
